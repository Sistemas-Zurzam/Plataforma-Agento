...
export default function EmpresaSedes({ empresaId, user }) {
  ...
  const puedeCrear = user?.permisos?.includes('sedes.crear');
  const puedeEditar = user?.permisos?.includes('sedes.editar');
