...
/**
 * Resultado de una exportación BBVA Net Cash — sin nada de HTTP (mismo
 * criterio que TelecreditoBcpExportResultado, pero completamente
 * separado: nunca se comparte código entre integraciones bancarias).
 */
final readonly class BbvaNetCashExportResultado
{
