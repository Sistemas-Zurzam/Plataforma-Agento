...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Sin este archivo, el validador de Laravel usa sus mensajes por
    | defecto en inglés (ej. "The ruc has already been taken.") porque
    | APP_LOCALE nunca tuvo una traducción real detrás — no es una regla
    | de negocio la que faltaba, era este archivo.
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute indicado aparece en una filtración de datos conocida. Elige otro :attribute.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Solo se agregan acá los pocos casos donde el mensaje genérico de
    | arriba no queda natural en español para un campo puntual — el resto
    | ya lo cubren las reglas generales.
    */

    'custom' => [
        'ruc' => [
            'unique' => 'Ese RUC ya está registrado por otra empresa.',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Traduce el nombre del campo dentro del mensaje (":attribute") para que
    | nunca se lea, por ejemplo, "El campo email es obligatorio" en vez de
    | "El campo correo electrónico es obligatorio". Se listan los campos
    | reales usados por los FormRequest de la aplicación.
    */
    ...
    'attributes' => [
        ...
        'inscrita_remype' => 'inscripción en REMYPE',
        'tipo_documento' => 'tipo de documento',
        'numero_documento' => 'número de documento',
        'fecha_nacimiento' => 'fecha de nacimiento',
        'celular_colaborador' => 'celular',
        'celular_referencia' => 'celular de referencia',
        'sede_id' => 'sede',
        'area_id' => 'área',
        'horario_id' => 'horario',
        'cargo' => 'cargo',
        ...
        'sistema_previsional' => 'sistema previsional',
        'afp_id' => 'AFP',
